...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header" style="background-color: rgb(0,130,181)">
                ...
                <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp; <img src="LogoSMS.png" alt="..." width="3%"> Student Management System</b></a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav" style="background-color: rgb(0,130,181)">
                <li class="dropdown">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse"  style="background-color: rgb(0,130,181)">
            <?php 
            include 'db.php';
